...
var AppCacheManager = /** @class */ (function (_super) {
    ...
    function AppCacheManager(options) {
        ...
        _this.TIME_TO_LIVE = core_1.config.cache.ttl;
        _this.read = function (key) { return __awaiter(_this, void 0, void 0, function () {
            var value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, JSON.parse(value)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
        _this.has = function (key) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(key)];
        ...
        _this.remove = function (key) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.has(key)];
                    case 1:
                        keyExists = _a.sent();
                        if (!keyExists)
                            throw new Error("You tried removing the cache with a key[".concat(key, "] that does not exists."));
        ...
        _super.prototype.on.call(_this, "close", function () {
            _this.quit();
