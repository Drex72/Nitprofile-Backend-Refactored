...
var OTPService = /** @class */ (function () {
     ...
     */
    OTPService.prototype._createOtp = function () {
        var digits = "123456789";
        var otpLength = 4;
        var otpArray = Array.from({ length: otpLength }, function () { return +digits[Math.floor(Math.random() * digits.length)]; });
        var otp = parseInt(otpArray.join(""), 10);
        return otp;
    };
    /**
     ...
     */
    OTPService.prototype._createOTPExp = function () {
