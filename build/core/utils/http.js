    ...
    function HttpHelper() {
        ...
        this.get = function (url) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest(url, "GET")];
            });
        }); };
        this.post = function (url, data) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest(url, "POST", data)];
            });
        }); };
        this.appendHeader = function (key, value) {
            _this.headers[key] = value;
            return _this;
        };
        this.makeRequest = function (url, method, data) { return __awaiter(_this, void 0, void 0, function () {
            var response, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
