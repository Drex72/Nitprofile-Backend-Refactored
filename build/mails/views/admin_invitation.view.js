...
exports.adminInvitationMail = void 0;
const adminInvitationMail = (data) => `
                            ...
                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                              <tr>
                                <td align="center" valign="top" class="textContent">
                                 ...
                                 <br>
                                  <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:20px;margin-bottom:10px;color:#C9BC20;line-height:135%;width:100%;margin-left:-20px;">{{program}}</h2>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                      <td valign="top" class="textContent">
                                        <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Hello  </h3>
                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:100%;margin-top:1em">
                                           ...
                                           <p>Congratulations you've be invited for the Admin role at NITHub Profile and Certification service (NITProfile) </p>
                                          <p>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #27a810;border-radius:5px;">
                                    <tr>
                                      <td align="center" valign="middle" class="buttonContent" style="padding-top:10px;padding-bottom:10px;padding-right:15px;padding-left:15px;">
                                        <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:135%;border-radius:5px;" href="https://nitprofile.unilag.edu.ng/" target="_blank">Go To Dashboard</a>
                                      </td>
                                    </tr>
                                  </table>
...
`;
exports.adminInvitationMail = adminInvitationMail;
