...
var FindNotificationEntity = /** @class */ (function () {
    function FindNotificationEntity(dbNotificationEntity) {
        ...
        this.handle = function () { return __awaiter(_this, void 0, void 0, function () {
            var allNotificationEntities;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dbNotificationEntity.findAll()];
                    case 1:
                        allNotificationEntities = _a.sent();
