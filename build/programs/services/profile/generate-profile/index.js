    ...
    function GenerateProfile(dbPrograms, dbUserPrograms, dbProgramNodes, dbUser) {
        ...
        this.handle = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var programId, userProgram, program, existingUser, programNodes, profilePictureNode, profile_url, refactoredNodes_1, profileImageUrl;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            if (!(!userProgram.profileImageUrl || existingUser.changed("profilePicSecureUrl"))) return [3 /*break*/, 7];
                            refactoredNodes_1 = [];
                        ...
                        case 5:
                            _b.sent();
                            profileImageUrl = (0, core_1.generateCloudinaryTransformationImage)({
